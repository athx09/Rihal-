    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title bg-white text-center  px-3">Reset Password</h6>
    ...
    foreach($rows as $pat)
    {
        ...
        if($password == $pat["password"])
        {
		  ...
		  <div class="alert alert-success role="alert" style="color:#000">
			 Password May Be Used Before Please Try Again
		 </div>
	 </div>
		<div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                ...
                <div class="col-lg-6 col-md-12 wow fadeInUp" data-wow-delay="0.5s">
                    <form method="post" action="reset-conn1.php">
                        <div class="row g-3">
                            
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Password Must Contains al least one number , one capital character and small character and must contian 8 numbers" name="password" required class="form-control" id="email" placeholder="Your Email">
                            ...
                            <div class="col-12">
                                <button class="btn btn-primary w-100 py-3" style="background-color: #7F4E25 !important;border: 1px solid #7F4E25" type="submit">Reset Password</button>
...
if($count>0){
    ...
    $sql = $con->prepare("SELECT * FROM customer WHERE customer_id != $id");
    $sql->execute();
    $rows = $sql->fetchAll();
