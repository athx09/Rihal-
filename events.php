        ...
        <div class="container">
            ...
            <div class="row g-4 justify-content-center">
                ...
                <?php
                        ...
                        include('connect.php');  
                        $sql = $con->prepare("SELECT events.* , places.name FROM events INNER JOIN places ON places.place_id = events.place_id");      
                        $sql->execute();
                        $rows = $sql->fetchAll();
                    ...
                    <div class="package-item">
                      ...
                      <?php }}else{
                        ...
                        include('connect.php'); 
                        $search = $_POST['search'];    
                        $sql = $con->prepare("SELECT events.* , places.name FROM events INNER JOIN places ON places.place_id = events.place_id WHERE events.event_id='$search'");      
                        $sql->execute();
                        $rows = $sql->fetchAll();
