    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                        <h6 class="section-title bg-white text-center  px-3">Add Event</h6>
          ...
          if(isset($_POST['add'])){
            ...
            include('../connect.php');  
            $sqlPL = $con->prepare("SELECT * FROM events WHERE (title='$name' AND event='$desc') OR (title='$name' OR event='$desc')");      
            $sqlPL->execute();
            ...
            if($countPL > 0){ 
                ...
                foreach($rowsPL as $pat){
                    ...
                    if(($pat['title'] == $name && $pat['event'] == $desc) || ($pat['title'] == $name || $pat['event'] == $desc)){
                ...
                $sql = "INSERT INTO events (title , event , event_type , place_id , department_id, image) VALUES ('$name' , '$desc' , '$type' , '$place_id' , '$department_id' , '$image')";
                ...
                <div class="col-lg-6 col-md-12 wow fadeInUp" data-wow-delay="0.5s">
                    <form method="post" enctype="multipart/form-data">
                        <div class="row g-3">
                            ...
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <textarea type="email" name="desc" required style="height: 300px" class="form-control" id="email" placeholder="Description"></textarea>
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <input type="file" name="image" required class="form-control" id="subject" placeholder="Subject">
